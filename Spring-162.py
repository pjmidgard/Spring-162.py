                            ...
                            if D==1:
                                ...
                                if i==1:
                                    ...
                                    while Extract1!=1:
                                            ...
                                            Root=int(University_file[(X2*8):(X2*8)+8],2)
                                            ...
                                            Times_12=int(University_file[(X2*8)+40:(X2*8)+48],2)
                                ...
                                if i==2:
                                    ...
                                    while Extract1!=1:
                                            ...
                                            SQUEAR_OF_ROOT=int(University_file[(X2*8)+24:(X2*8)+32],2)
                                            Multiply_Times=int(University_file[(X2*8)+32:(X2*8)+40],2)
                                            Root=int(University_file[(X2*8)+40:(X2*8)+48],2)
                                            if Root==0:
                                                Root=1
                                            counts+=1
                                            if SQUEAR_OF_ROOT>=68719476736:
